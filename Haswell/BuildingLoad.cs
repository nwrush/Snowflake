...
namespace Haswell
{
    ...
    {
        public const string RESIDENTIAL_FILE = "Residential.json";
        public const string COMMERCIAL_FILE = "Commercial.json";
        public const string INDUSTRIAL_FILE = "Industrial.json";
